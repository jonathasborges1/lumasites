...
export default function SiteParaPsicologoEmManausPage() {
  return (
    <>
      <script
          ...
          <div className="relative mx-auto max-w-5xl px-5 md:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-10 flex flex-wrap items-center gap-5 text-sm text-ink-muted">
                ...
                <span className="flex items-center gap-1.5">
                  <HeartHandshake size={14} className="text-accent-amber/70" />
                  Para psicólogos e psicólogas
                </span>
              </div>
              ...
              <div className="max-w-3xl space-y-4 border-l-2 border-glow-cyan/30 pl-6 text-base leading-relaxed text-ink-secondary md:text-lg">
                <p>
                  Para muitos psicólogos, presença digital ainda parece um tema delicado. Existe o
                  cuidado ético com a comunicação, o receio de parecer comercial demais e, ao mesmo
                  tempo, a percepção de que pacientes pesquisam no Google antes de tomar uma decisão.
                </p>
                <p>
                  Quando alguém busca por terapia em Manaus, psicóloga perto de mim ou atendimento
                  psicológico online, a primeira impressão acontece antes da mensagem. Um site para
                  psicólogo em Manaus organiza essa presença com clareza, acolhimento e estrutura
                  para ser encontrado.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-8 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                ...
                <span className="text-glow-aqua"> psicólogos em Manaus</span>
              </h2>
            </ScrollReveal>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-4 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                O que um site para psicólogo
                <span className="text-glow-aqua"> deve ter</span>
              </h2>
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-ink-secondary">
                Um site de psicologia deve ser simples, mas completo. Ele precisa acolher dúvidas,
                transmitir seriedade e facilitar o primeiro contato sem parecer uma venda agressiva.
              </p>
            </ScrollReveal>
        ...
        <section className="bg-deep-blue/30 py-16 md:py-20">
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              ...
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-ink-secondary">
                O processo precisa unir estratégia, cuidado de linguagem e base técnica para SEO
                local. Estas são as etapas que fazem diferença.
              </p>
            </ScrollReveal>
              ...
              <div className="relative overflow-hidden rounded-2xl border border-glow-cyan/30 bg-gradient-to-br from-deep-blue/80 to-surface/60 p-8 text-center md:p-10">
                ...
                <div className="relative">
                  ...
                  <p className="mx-auto mb-7 max-w-2xl text-lg leading-relaxed text-ink-primary md:text-xl">
                    Se você é psicólogo em Manaus e deseja fortalecer sua presença profissional no
                    Google, ter um site estruturado pode ser um diferencial importante.
                  </p>
                  <GlowButton
                    href={wppLink}
                    target="_blank"
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-8 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                ...
                <span className="text-glow-aqua"> ético e encontrável</span>
              </h2>
            </ScrollReveal>
              ...
              <div className="rounded-2xl border border-accent-amber/20 bg-accent-amber/5 p-6 md:p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-ink-secondary md:text-base">
                      Um site para psicologia não deve prometer resultados ou usar linguagem
                      apelativa. A força está em informar bem, transmitir confiança e facilitar o
                      contato para quem já está procurando apoio.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <ScrollReveal>
              <div className="mb-12">
                ...
                <h2 className="font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                  Perguntas frequentes sobre site para psicólogo em Manaus
                </h2>
              </div>
            </ScrollReveal>
          ...
          <div className="relative mx-auto max-w-3xl px-5 text-center md:px-8">
            <ScrollReveal>
              <h2 className="mb-6 font-display text-3xl uppercase text-ink-primary md:text-4xl lg:text-5xl">
                ...
                <span className="text-glow-aqua"> transmite confiança?</span>
              </h2>
