...
export default function SiteParaPersonalTrainerEmManausPage() {
  return (
    <>
      <script
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema(
              [{ label: "Blog", href: "/blog" }, { label: "Site para Personal Trainer em Manaus" }],
              site.url,
            ),
          ),
        }}
            ...
            <div className="max-w-4xl">
              <div className="mb-6 flex items-center gap-3">
                ...
                <span className="font-display text-xs uppercase tracking-[0.35em] text-glow-aqua">
                  SEO local para personal trainers
                </span>
                <span className="h-px w-8 bg-glow-cyan/70" />
              </div>
              ...
              <h1 className="mb-8 font-display text-3xl uppercase leading-[1.1] text-ink-primary sm:text-4xl md:text-5xl lg:text-[3.4rem]">
                ...
                <br />
                presença digital para crescer além das redes sociais
              </h1>
              ...
              <div className="mb-10 flex flex-wrap items-center gap-5 text-sm text-ink-muted">
                ...
                <span className="flex items-center gap-1.5">
                  <Dumbbell size={14} className="text-accent-amber/70" />
                  Para personal trainers e educadores físicos
                </span>
              </div>
              ...
              <div className="max-w-3xl space-y-4 border-l-2 border-glow-cyan/30 pl-6 text-base leading-relaxed text-ink-secondary md:text-lg">
                <p>
                  Manaus tem um mercado fitness em crescimento constante. Academias espalhadas por
                  toda a cidade, cultura de atividade física ao ar livre e demanda por
                  acompanhamento profissional em bairros como Adrianópolis, Dom Pedro, Chapada e
                  Parque 10.
                </p>
                <p>
                  Quando alguém pesquisa por personal trainer em Manaus, educador físico domiciliar
                  no Adrianópolis ou assessoria de treino online, o primeiro contato já aconteceu
                  antes de qualquer mensagem no WhatsApp. Um site para personal trainer em Manaus
                  organiza essa presença com credibilidade e estrutura para ser encontrado no Google.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-8 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                ...
                <span className="text-glow-aqua"> personal trainers em Manaus</span>
              </h2>
            </ScrollReveal>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-4 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                O que um site para personal trainer
                <span className="text-glow-aqua"> deve ter</span>
              </h2>
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-ink-secondary">
                Um site de personal trainer precisa ser claro, rápido e confiável. Ele apresenta o
                profissional, as modalidades de treino e facilita o primeiro contato sem depender de
        ...
        <section className="bg-deep-blue/30 py-16 md:py-20">
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              ...
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-ink-secondary">
                O processo une estratégia de conteúdo, comunicação ética dentro das diretrizes do
                CREF e base técnica para SEO local. Estas são as etapas que fazem diferença.
              </p>
            </ScrollReveal>
              ...
              <div className="relative overflow-hidden rounded-2xl border border-glow-cyan/30 bg-gradient-to-br from-deep-blue/80 to-surface/60 p-8 text-center md:p-10">
                ...
                <div className="relative">
                  ...
                  <p className="mx-auto mb-7 max-w-2xl text-lg leading-relaxed text-ink-primary md:text-xl">
                    Se você é personal trainer em Manaus e quer fortalecer sua presença no Google,
                    um site bem estruturado pode ser o diferencial para conquistar novos alunos além
                    das redes sociais.
                  </p>
                  <GlowButton
                    href={wppLink}
              ...
              <div className="rounded-2xl border border-accent-amber/20 bg-accent-amber/5 p-6 md:p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-ink-secondary md:text-base">
                      Um site para personal trainer deve seguir as diretrizes do CREF: sem promessas
                      de resultados específicos como perda de X quilos em Y semanas, sem comparativos
                      entre alunos e sem linguagem que minimize a importância da individualidade
                      biológica. A força da presença digital de um educador físico está em comunicar
                      metodologia, credenciais e resultados reais — não em fazer promessas que
                      dependem de variáveis fora do controle do profissional.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <ScrollReveal>
              <div className="mb-12">
                ...
                <h2 className="font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                  Perguntas frequentes sobre site para personal trainer em Manaus
                </h2>
              </div>
            </ScrollReveal>
          ...
          <div className="relative mx-auto max-w-3xl px-5 text-center md:px-8">
            <ScrollReveal>
              <h2 className="mb-6 font-display text-3xl uppercase text-ink-primary md:text-4xl lg:text-5xl">
                Pronto para conquistar alunos
                <span className="text-glow-aqua"> além das redes sociais?</span>
              </h2>
              ...
              <p className="mx-auto mb-10 max-w-xl text-base leading-relaxed text-ink-secondary md:text-lg">
                ...
                Manaus, com conteúdo pensado para transformar pesquisa no Google em novos alunos
                para o seu trabalho.
              </p>
