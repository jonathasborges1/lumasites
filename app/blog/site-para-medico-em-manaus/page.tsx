...
export default function SiteParaMedicoEmManausPage() {
  return (
    <>
      <script
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema(
              [{ label: "Blog", href: "/blog" }, { label: "Site para Médico em Manaus" }],
              site.url,
            ),
          ),
        }}
          ...
          <div className="relative mx-auto max-w-5xl px-5 md:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-10 flex flex-wrap items-center gap-5 text-sm text-ink-muted">
                ...
                <span className="flex items-center gap-1.5">
                  <Stethoscope size={14} className="text-accent-amber/70" />
              ...
              <div className="max-w-3xl space-y-4 border-l-2 border-glow-cyan/30 pl-6 text-base leading-relaxed text-ink-secondary md:text-lg">
                <p>
                  A maioria dos pacientes pesquisa no Google antes de agendar uma consulta. Mesmo
                  quando recebem uma indicação, verificam nome, especialidade e credenciais do
                  profissional antes de entrar em contato.
                </p>
                <p>
                  Quando alguém busca por cardiologista em Manaus, dermatologista no Adrianópolis
                  ou pediatra perto de mim, a primeira impressão acontece antes da ligação. Um site
                  para médico em Manaus organiza essa presença com clareza, seriedade e estrutura
                  para ser encontrado.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-8 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                ...
                <span className="text-glow-aqua"> médicos em Manaus</span>
              </h2>
            </ScrollReveal>
          ...
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              <h2 className="mb-4 font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                O que um site para médico
                <span className="text-glow-aqua"> deve ter</span>
              </h2>
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-ink-secondary">
                Um site médico precisa ser informativo, rápido e confiável. Ele orienta o paciente,
                transmite seriedade e facilita o agendamento sem linguagem comercial inadequada.
              </p>
            </ScrollReveal>
        ...
        <section className="bg-deep-blue/30 py-16 md:py-20">
          <div className="mx-auto max-w-4xl px-5 md:px-8">
            <ScrollReveal>
              ...
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-ink-secondary">
                O processo une estratégia, linguagem responsável e base técnica para SEO local.
                Estas são as etapas que fazem diferença.
              </p>
            </ScrollReveal>
              ...
              <div className="relative overflow-hidden rounded-2xl border border-glow-cyan/30 bg-gradient-to-br from-deep-blue/80 to-surface/60 p-8 text-center md:p-10">
                ...
                <div className="relative">
                  ...
                  <p className="mx-auto mb-7 max-w-2xl text-lg leading-relaxed text-ink-primary md:text-xl">
                    Se você é médico em Manaus e deseja fortalecer sua presença no Google, um site
              ...
              <div className="rounded-2xl border border-accent-amber/20 bg-accent-amber/5 p-6 md:p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-ink-secondary md:text-base">
                      Um site para médico deve seguir as diretrizes do CFM: sem promessas de cura,
                      sem depoimentos de pacientes e sem linguagem sensacionalista. A força da
                      presença digital médica está em informar bem, transmitir credibilidade e
                      facilitar o contato para quem está buscando atendimento qualificado.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <ScrollReveal>
              <div className="mb-12">
                ...
                <h2 className="font-display text-2xl uppercase text-ink-primary md:text-3xl lg:text-4xl">
                  Perguntas frequentes sobre site para médico em Manaus
                </h2>
              </div>
            </ScrollReveal>
