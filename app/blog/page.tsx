...
export const metadata: Metadata = {
  title: "Blog sobre Sites Profissionais em Manaus",
  description:
...
const posts = [
  ...
  },
  {
    ...
    title: "Site para Dentista em Manaus: como consultórios independentes competem no Google",
    description:
      "Comportamento de busca do paciente, concorrência com as grandes redes odontológicas, o tripé mapa + avaliações + site e o que a Resolução CFO-196/2019 permite publicar.",
  ...
  },
  {
    ...
    title: "Site para Advogados em Manaus: estrutura, captação ética e regras da OAB",
    description:
      "Formatos e valores de site jurídico, SEO local e o que o Provimento 205/2021 da OAB permite publicar — de tráfego pago ao uso da palavra especialista.",
  ...
  {
    slug: "quanto-custa-um-site-em-manaus",
    title: "Quanto custa um site em Manaus em 2026? Valores reais, sem enrolação",
    description:
      "Faixas de preço por tipo de site, custos fixos de domínio e hospedagem, cobranças escondidas para evitar e como comparar orçamentos de igual para igual.",
    publishedAt: "2026-04-23",
    publishedLabel: "23 de abril de 2026",
    updatedAt: "2026-07-07",
    updatedLabel: "7 de julho de 2026",
